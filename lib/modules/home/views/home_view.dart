    ...
    return Column(
      children: [
        ...
        Obx(
          () => InkWell(
            onTap: () {
              if (controller.userInfo.value.typeLogin == Numeral.TYPE_CHECKIN_LOCATION && controller.userInfo.value.companyInfo!.typeCheckLogin! != Numeral.TYPE_CHECKIN_WIFI){
                controller.updateCheckInStatus();
              } else if (controller.userInfo.value.typeLogin == Numeral.TYPE_CHECKIN_WIFI && controller.userInfo.value.companyInfo!.typeCheckLogin! != Numeral.TYPE_CHECKIN_LOCATION){
