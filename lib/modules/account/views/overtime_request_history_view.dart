...
import 'package:attendance_fast/modules/account/widget/item_overtime_request_history.dart';
...
class OverTimeRequestHistoryView
    extends GetView<OvertimeRequestHistoryController> {
  const OverTimeRequestHistoryView({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
                      ...
                      child: Obx(
                        () => GestureDetector(
                          onTap: () => getPickDateDialog(
                              controller.dateGetOvertimeRequest, "month"),
                          child: Row(
                            ...
                            children: [
                              ...
                              BaseText(
                                isTile: true,
                                text: controller
                                        .checkFilterOvertimeRequest.value
                                    ? controller.datesGetOvertimeRequest.value
                                    : DateFormat("MMMM yyyy").format(controller
                                        .dateGetOvertimeRequest.value),
                              ),
                            ],
                          ),
                        ),
                  ...
                  child: Row(
                    ...
                    children: [
                      BaseCardStatistics(
                        ...
                        sizeText: 18,
                        value: controller.overtimeRequest.toString(),
                        sizeValue: 32,
                        icon: SizedBox(
                      ...
                      BaseCardStatistics(
                        ...
                        text: "total_hours".tr,
                        sizeText: 18,
                        value: controller.overtimeHours.toStringAsFixed(1),
                        sizeValue: 32,
                        icon: SizedBox(
                          height: Numeral.WIDTH_SCREEN * 0.08,
                          width: Numeral.WIDTH_SCREEN * 0.08,
              ...
              Expanded(
                child: Obx(
                  () => ListView.builder(
                    itemCount: controller.overtimeRequestHistory.length,
                    itemBuilder: (context, index) {
                      return ItemOverTimeRequestHistory(
                          overtimeRequest:
                              controller.overtimeRequestHistory[index]);
                    },
                  ),
                ),
              ),
            ...
            actions: [
              TextButton(
                ...
                onPressed: () {
                  ...
                  if (type == "month") {
                    controller.callApiGetOvertimeRequestHistory(
                        timeStart: DateTime(
