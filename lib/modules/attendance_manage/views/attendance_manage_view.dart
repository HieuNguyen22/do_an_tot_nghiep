...
import 'package:attendance_fast/modules/attendance_manage/widgets/bottom_input_name_csv.dart';
import 'package:attendance_fast/modules/attendance_manage/widgets/item_casual_leave.dart';
import 'package:attendance_fast/modules/attendance_manage/widgets/item_checkin.dart';
import 'package:attendance_fast/modules/attendance_manage/widgets/item_late.dart';
...
class AttendanceManageView extends GetView<AttendanceCheckInManageController> {
  const AttendanceManageView({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Row(
                children: [
                                ...
                                .map((item) => DropdownMenuItem<String>(
                                      ...
                                      child: Container(
                                        margin: EdgeInsets.only(
                                            left: Numeral.WIDTH_SCREEN * 0.0125),
                                        child: Row(
                                          mainAxisAlignment:
                  ...
                  InkWell(
                    onTap: () {
                      Get.bottomSheet(bottomSelectDate());
                    },
                    child: Container(
                      width: Numeral.WIDTH_SCREEN * 0.425,
                      height: Get.height * 0.06,
              ...
              Obx(
                () => Expanded(
                  child: controller.indexSelect.value ==
                      ...
                      : controller.indexSelect.value == Numeral.SELECT_LIST_LATE
