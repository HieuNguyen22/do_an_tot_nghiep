...
import 'package:attendance_fast/modules/company_setting/widgets/custom_google_map.dart';
import 'package:attendance_fast/themes/app_color.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class LocationCompanyView extends GetView<CompanySettingController> {
  const LocationCompanyView({super.key});
    ...
    return Scaffold(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 70,
            left: Numeral.WIDTH_SCREEN * 0.1,
            right: Numeral.WIDTH_SCREEN * 0.1,
            child: Container(
  ...
  getLocationCustom() {
    controller.createGoogleMapController();
    return Expanded(
