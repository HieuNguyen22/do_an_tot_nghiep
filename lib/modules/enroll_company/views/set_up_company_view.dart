...
import 'package:attendance_fast/modules/enroll_company/widgets/custom_google_map.dart';
...
class SetUpCompanyView extends GetView<EnrollCompanyController> {
  @override
  ...
  Widget getLocationWidget() {
    return GestureDetector(
      onTap: () => Get.toNamed(Routes.GET_LOCATION),
      child: Obx(
        () => Column(
  ...
  getLocationOption(String imagePath, String label, String description) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
