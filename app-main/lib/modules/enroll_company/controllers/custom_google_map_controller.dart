...
import 'package:app_work_log/modules/enroll_company/services/custom_info_window.dart';
import 'package:app_work_log/modules/enroll_company/services/location_service.dart';
...
class CustomGoogleMapController {
  static CameraPosition kInitialPosition = CameraPosition(
    target: LatLng(
      LocationService.instance.getLastKnowPosition.latitude,
